(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (ranger persp-mode-projectile-bridge persp-mode olivetti org-projectile evil-org prettier-js json-mode sqlup-mode sql-indent yaml-mode git-gutter eldoc-box expand-region ace-window org-dashboard org-pomodoro org-tree-slide org-preview-html toc-org org-rich-yank ob-ipython ob-rust ob-go org-fancy-priorities org-bullets pyvenv counsel-tramp ivy-yasnippet amx flx centered-cursor-mode dashboard electric-operator hungry-delete rainbow-delimiters yasnippet-snippets beacon default-text-scale popwin eshell-z esh-help eshell-prompt-extras virtualenvwrapper company-anaconda anaconda-mode yapfify smart-semicolon ccls aggressive-indent elisp-refs company-lsp lsp-ui lsp-mode flycheck prettify-utils imenu-list fill-column-indicator gitconfig-mode gitignore-mode gitattributes-mode browse-at-remote git-messenger git-timemachine magit-todos evil-magit magit ibuffer-projectile hl-todo highlight-indent-guides symbol-overlay esup diffview daemons carbon-now-sh restart-emacs rg editorconfig which-key treemacs-projectile treemacs-evil treemacs diredfl all-the-icons-dired dired-quick-sort yasnippet company-box company ivy-hydra ivy-xref counsel-projectile counsel hide-mode-line vim-empty-lines-mode hlinum winum doom-themes doom-modeline all-the-icons-ivy font-lock+ evil-fringe-mark evil-visualstar evil-surround evil-escape evil-anzu evil-major-leader evil-leader fontify-face anzu paradox quelpa-use-package diminish quelpa use-package))))
