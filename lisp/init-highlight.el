...
(use-package highlight-indent-guides
  ...
  (set-face-attribute 'highlight-indent-guides-top-character-face nil :foreground petmacs-favor-color :bold t)
  (with-no-warnings
...
;;          (highlight-indentation-mode . highlight-indentation-current-column-mode))
;;   :init (setq highlight-indentation-current-column-overlay-priority 2))

;; (use-package indent-guide
;;   :hook ((c-mode c++-mode cmake-mode python-mode emacs-lisp-mode) . indent-guide-mode)
;;   :config
;;   (set-face-attribute 'indent-guide-face nil :foreground petmacs-favor-color :bold t))
